...
class $ActivityTypesTable extends ActivityTypes
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, sortOrder, measureType];
  @override
...
class ActivityTypeRow extends DataClass implements Insertable<ActivityTypeRow> {
  ...
  @override
  int get hashCode => Object.hash(id, name, sortOrder, measureType);
  @override
...
class $ActivityRecordsTable extends ActivityRecords
  ...
  static const VerificationMeta _timeUnitMeta = const VerificationMeta(
    'timeUnit',
  );
  @override
  late final GeneratedColumn<String> timeUnit = GeneratedColumn<String>(
    'time_unit',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  ActivityRecordRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ActivityRecordRow(
      ...
      timeUnit: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class $$ActivityRecordsTableFilterComposer
  ...
  ColumnFilters<String> get timeUnit => $composableBuilder(
